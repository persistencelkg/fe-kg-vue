...
export const loginCheck = (params: Record<string, any>) => {
    return ssoPost<LoginResponse>("/login-check", params, {underlineKey: true});
}
export const loginOut = (params: Record<string, any>) => ssoPost<LoginOutResp>("/login-out", params, {underlineKey: true,noParamsKey: true})
export const fetchPermission = (params: Record<string, any>) => permissionPost<AuthListResp>("/permission-fetch", params, {underlineKey: true, noParamsKey: true})
